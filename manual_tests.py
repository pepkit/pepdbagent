...
con.upload_project(namespace="test_11", name='sub', tag='f1', project=proj, is_private=True, overwrite=True)
...
ff = con.update_item(namespace="test_11", name="new_name", tag='balck', update_dict={'project': gf,
                                                                                 'is_private': True,
                                                                                 'tag': "balck",
                                                                                 'name': "boo"
                                                                                })
