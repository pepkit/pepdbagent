...
###############
# Upload
prj = peppy.Project('/home/bnt4me/virginia/repos/pepdbagent/sample_pep/basic/project_config.yaml')
con.project.submit(project=prj, namespace="Khoroshevskyi", name='dupa', tag='test1', overwrite=True)
